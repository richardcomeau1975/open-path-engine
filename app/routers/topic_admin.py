...
async def _generate_text_output(
    ...
    if output_type == "learning_asset":
        ...
        result_text = await _call_claude(prompt, model="claude-sonnet-4-6", max_tokens=16384)
        ...
        result_text = await _call_claude(prompt, model="claude-sonnet-4-6", max_tokens=8192)
